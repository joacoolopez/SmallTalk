...
export function Navbar() {
  ...
  return (
    ...
    >
      <nav
        ref={navRef}
        className="relative flex items-center justify-between px-6 py-3 rounded-full bg-zinc-900/80 backdrop-blur-md border border-zinc-800"
      >
        {/* Logo */}
        ...
        <div className="hidden md:flex items-center">
          <Button asChild size="sm" className="shimmer-btn bg-[#18214b] text-white hover:bg-[#252f5c] rounded-full px-4">
          <a href="#calendly">
            Agendar Demo
          </a>
        </Button>
